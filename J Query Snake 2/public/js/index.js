var direction = 'right', speed = 2000, ticker = null, fruitCell = [], score = 0, size = 50;
var snakeCells = [
    [10, 14],
    [10, 13],
    [10, 12],
    ...
    if (newCell.length == 0) {
        ...
        else if(score == 1000)
        {
            ...
            if (newCell.hasClass('fruitCell')) {
                ...
                renderFruitCell();
                score += 10;
                $('#scoreBoard').html('Your Score : ' + score +'&emsp;&emsp;<a href="/index.html">Reset</a> &emsp; &emsp; High Score : 1000');
